...
function getSecondaryLanguage(lang) {
...
function formatBilingual(primaryText, secondaryText, primaryLang = state.language) {
...
function createTask(title, date, start, end, priority, tag, completed, notes) {
  return {
    id: randomId(),
    title,
