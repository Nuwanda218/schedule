(() => {
  const func = (root, initTheme, changeTheme) => {
    ...
    components.onclick = () => {
      if (isMoved) {
        ...
        mainButton.style.backgroundColor = "var(--toggle-sun-bg)";

        mainButton.style.boxShadow =
          "3em 3em 5em var(--toggle-shadow-strong), inset  -3em -5em 3em -3em var(--toggle-shadow-strong), inset  4em 5em 2em -2em var(--toggle-sun-glow)";
        ...
        components.style.backgroundColor = "var(--toggle-day-sky)";
        ...
        mainButton.style.backgroundColor = "var(--toggle-moon-bg)";

        mainButton.style.boxShadow =
          "3em 3em 5em var(--toggle-shadow-strong), inset  -3em -5em 3em -3em var(--toggle-shadow-strong), inset  4em 5em 2em -2em var(--toggle-moon-glow)";
        ...
        components.style.backgroundColor = "var(--toggle-night-sky)";
  ...
  class ThemeButton extends HTMLElement {
    ...
    connectedCallback() {
      ...
      style.textContent = `
* { margin: 0; padding: 0; transition: 0.7s; -webkit-tap-highlight-color: var(--toggle-tap-highlight); }
...
.components { position: relative; width: 180em; height: 70em; background-color: var(--toggle-day-sky); border-radius: 100em; box-shadow: inset 0 0 5em 3em var(--toggle-shadow-strong); overflow: hidden; transition: 0.7s; transition-timing-function: cubic-bezier(0, 0.5, 1, 1); cursor: pointer; }
.main-button { margin: 7.5em 0 0 7.5em; width: 55em; height: 55em; background-color: var(--toggle-sun-bg); border-radius: 50%; box-shadow: 3em 3em 5em var(--toggle-shadow-strong), inset -3em -5em 3em -3em var(--toggle-shadow-strong), inset 4em 5em 2em -2em var(--toggle-sun-glow); transition: 1.0s; transition-timing-function: cubic-bezier(0.56, 1.35, 0.52, 1.0); }
.moon { position: absolute; background-color: var(--toggle-moon-surface); box-shadow: inset 0em 0em 1em 1em var(--toggle-shadow-soft); border-radius: 50%; transition: 0.5s; opacity: 0; }
...
.daytime-background { position: absolute; border-radius: 50%; transition: 1.0s; transition-timing-function: cubic-bezier(0.56, 1.35, 0.52, 1.0); }
.daytime-background:nth-child(2) { top: -20em; left: -20em; width: 110em; height: 110em; background-color: var(--toggle-day-glow-1); z-index: -2; }
.daytime-background:nth-child(3) { top: -32.5em; left: -17.5em; width: 135em; height: 135em; background-color: var(--toggle-day-glow-2); z-index: -3; }
.daytime-background:nth-child(4) { top: -45em; left: -15em; width: 160em; height: 160em; background-color: var(--toggle-day-glow-3); z-index: -4; }
.cloud, .cloud-light { transform: translateY(10em); transition: 1.0s; transition-timing-function: cubic-bezier(0.56, 1.35, 0.52, 1.0); }
.cloud-son { position: absolute; background-color: var(--toggle-cloud); border-radius: 50%; z-index: -1; transition: transform 6s, right 1s, bottom 1s; }
...
.stars { transform: translateY(-125em); z-index: -2; transition: 1.0s; transition-timing-function: cubic-bezier(0.56, 1.35, 0.52, 1.0); }
.big { --size: 7.5em; }
.medium { --size: 5em; }
.small { --size: 3em; }
...
.star-son { width: var(--size); height: var(--size); background-image: radial-gradient(circle var(--size) at var(--pos), transparent var(--size), var(--toggle-star)); }
.star { transform: scale(1); transition-timing-function: cubic-bezier(0.56, 1.35, 0.52, 1.0); transition: 1s; animation-iteration-count: infinite; animation-direction: alternate; animation-timing-function: linear; }
